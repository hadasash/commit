...
var UserService = (function () {
    ...
    UserService.prototype.registerUser = function (createUserDto) {
    ...
    UserService.prototype.findByUsername = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.userModel.findOne({ username: username }).exec()];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.userModel.findById(id).exec()];
                    case 1:
                        user = _a.sent();
                        return [2, user];
                    case 2:
                        error_1 = _a.sent();
                        console.error('Error getting user by ID from database:', error_1);
    ...
    UserService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.userModel.find().exec()];
            });
        });
    };
